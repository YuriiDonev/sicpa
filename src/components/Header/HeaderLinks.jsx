...
class HeaderLinks extends Component{
    ...
    render(){
        return(
            <div className='mobile-view-logout-help-container'>
              <div><a href='https://dockmastershelp.wordpress.com' target='_blank' rel="noopener noreferrer">
              <i className="pe-7s-help1"></i>{'HELP CENTER'}</a></div>
              <div onClick={() => {this.props.logOut()}}><i className="pe-7s-close-circle"></i>{'LOG OUT'}</div>
            </div>
        );
    }
}
...
//                           <div className="text-danger" onClick={() => {this.props.logOut()}}><i className="pe-7s-close-circle"></i>{'Log out'}</div>
//                         </MenuItem>
//                         <MenuItem eventKey={4.5} href='https://dockmastershelp.wordpress.com' target='_blank'>
